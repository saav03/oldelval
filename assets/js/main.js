...
(function () {
  ...
  //Sidebar catchable
  const elemMenu = document.getElementsByClassName('catchable-menu');
  const elemMenuSolo = document.getElementsByClassName('catchable-menu-solo');
  for (let i = 0; i < elemMenu.length; i++) {
    elemMenu[i].addEventListener('click', () => {
  ...
  for (let i = 0; i < elemMenuSolo.length; i++) {
    elemMenuSolo[i].addEventListener('click', () => {
  ...
  window.addEventListener('DOMContentLoaded', (event) => {
    ...
    if(elem2){
      document.getElementById(elem2).classList.toggle('collapsed');
    }
