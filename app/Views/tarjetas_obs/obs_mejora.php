<div class="card-body">
    <fieldset class="fieldset_mejora fieldset_add_hallazgo">
        ...
        <div class="row p-3">
            ...
            <div class="col-xs-12 col-md-6">
                <fieldset style="border-right: 0;">
                    <legend style="width: 100%;" class="d-flex justify-content-between">
                        Plan de acción
                        <div class="d-flex align-items-center gap-2">
                            <?php if ($h['plan_accion_implementado']) : ?>
                                <i class="fa-regular fa-square-check"></i>
                                <label for="">Plan de Acción Implementado</label>
                            <?php else : ?>
                                <i class="fa-regular fa-circle-xmark"></i>
                                <label for="">Plan de Acción No Implementado</label>
                            <?php endif; ?>
                        </div>
                    </legend>
                    <div class="row" style="padding: 10px 50px;">
        ...
        <?php if ($h['plan_accion_implementado'] == 1 && $h['resuelto'] == 1) : ?>
            <div class="d-flex align-items-center gap-2 justify-content-center" style="font-size: 15px; font-weight: 500;">
                <i class="fa-solid fa-circle-exclamation"></i>
                El plan de acción fue implementado. Por lo cuál, no requiere de tratamiento
            </div>
        <?php else : ?>
            <div>
                <div class="row">
