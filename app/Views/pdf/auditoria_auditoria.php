...
<head>
    ...
    <title>Oldelval - Auditoría Auditoria</title>
...
<body>
    ...
    <table width="100%;" style="border: 1px solid #494949; border-radius: 5px; margin-top: 15px;">
        <th style="font-size: 12px; color: #64748B; padding: 4px 0; background-color: #f5f5f5; border-radius: 5px;">
            Datos Principales</th>
    </table>

    <table width="100%;"
        style="border: 1px solid #494949; border-radius: 5px; margin-top: 6px; font-size: 12px; text-align: center; color: #686868;">
        <thead>
            <tr>
        ...
        <tbody style="border-bottom: 1px solid #494949;">
            <tr>
                <td class="td_content">
                    <?= $auditoria['contratista'] ? $auditoria['contratista'] : ''; ?>
                </td>
                <td class="td_content">
                    <?= $auditoria['supervisor_responsable'] ? $auditoria['supervisor_responsable'] : ''; ?>
                </td>
                <td class="td_content">
                    <?= $auditoria['cant_personal'] ? $auditoria['cant_personal'] : ''; ?>
                </td>
                <td class="td_content">
                    <?= $auditoria['num_informe'] ? $auditoria['num_informe'] : '---'; ?>
                </td>
            </tr>
        </tbody>
        ...
        <tbody>
            <tr>
                <td class="td_content_dos">
                    <?= $auditoria['proyecto'] ? $auditoria['proyecto'] : ''; ?>
                </td>
                <td class="td_content_dos">
                    <?= $auditoria['modulo'] ? $auditoria['modulo'] : 'No Aplica'; ?>
                </td>
                <td class="td_content_dos">
                    <?= $auditoria['estacion'] ? $auditoria['estacion'] : 'No Aplica'; ?>
                </td>
                <td class="td_content_dos">
                    <?= $auditoria['sistema'] ? $auditoria['sistema'] : 'No Aplica'; ?>
                </td>
            </tr>
        </tbody>
    ...
    <div style="border: 1px solid #494949; border-radius: 5px; margin-top: 6px;">
        ...
        foreach ($auditoria['bloque'] as $bloque): ?>
            <div
                style="background-color: #ebeef4; margin: 3px; border-radius: 5px; padding: 2px 0; color: black; font-size: 12px; text-align: center; font-weight: bold;">
                <?= $bloque['nombre']; ?>
            </div>
            <!-- Preguntas Bloque -->
            <table width="100%;" style="margin-top: 6px; text-align: center; font-size: 12px;">
                <tbody>
                    <?php foreach ($bloque['preguntas_rtas'] as $rtas):
                        $i++; ?>
                        <tr>
                            <td style="text-align: left; width: 82%;">
                                <div
                                    style="margin: 1px; border-radius: 5px; padding: 2px 0 2px 5px; font-size: 12px; color: #686868;">
                                    <small><b>(
                                            <?= $i; ?> )
                                        </b></small>
                                    <?= $rtas['respuesta'][0]['pregunta']; ?>
                                </div>
                            </td>
                            <td style="width:18%;">
                                <?php if ($rtas['respuesta'][0]['rta'] == -1) { ?>
                                    <div
                                        style="color: #ECB675; border-radius: 5px; color: white; font-weight: bold; font-size: 15px; margin: 0px 20px; padding: -5px 5px;">
                                        <i class="fa-solid fa-square-minus" style="color: #ECB675;"></i>
                                    </div>
                                <?php } else if ($rtas['respuesta'][0]['rta'] == 0) { ?>
                                        <div
                                            style="border-radius: 5px; color: white; font-weight: bold; font-size: 12px; margin: 0px 20px; padding: 0 10px;">
    ...
    <?php if (!is_null($hallazgo)): ?>
        ...
        <table width="100%;"
            style="color: #343434;border: 1px solid #494949; border-radius: 5px; margin-top: 15px; font-size: 12px; text-align: center; color: #686868; ">
            <thead style="border-bottom: 1px solid #494949;">
                <tr>
                    <th
                        style="width: 50%; border-right: 1px solid #494949; background-color: #f1f1f1; border-radius: 5px 0 0 0; color: #343434;">
                        Hallazgo
                    </th>
        ...
        <table width="100%;"
            style="border: 1px solid #494949; border-radius: 5px; margin-top: 15px; font-size: 12px; text-align: center; color: #686868; ">
            <thead style="border-bottom: 1px solid #494949;">
                <tr>
                    <th colspan="4"
                        style="padding: 3px 0; background-color: #f1f1f1; border-radius: 5px 5px 0 0; color: #343434;">
                        Significancia</th>
                </tr>
            </thead>
            ...
            <tbody>
                <?php if (count($hallazgo['efectos']) > 0): ?>
                    <?php foreach ($hallazgo['efectos'] as $efecto): ?>
                        <tr>
                            <td style="width: 100%;"><span class="checkmark">&#10003;</span>
        ...
        <table width="100%;"
            style="border: 1px solid #494949!important; border-radius: 5px; margin-top: 15px; font-size: 12px; text-align: center; color: #686868; ">
            <thead style="border-bottom: 1px solid #494949;">
                <tr>
                    <th
                        style="width: 50%; padding: 3px 0; border-right: 1px solid #494949; background-color: #f1f1f1; border-radius: 5px 0 0 0; color: #343434;">
                        Contratista</th>
                    <th
                        style="width: 50%; padding: 3px 0; background-color: #f1f1f1; border-radius: 0 5px 0 0; color: #343434;">
                        Responsable</th>
                </tr>
            </thead>
            ...
            <tbody>
                <tr>
                    <td style="border-right: 1px solid #494949; border-bottom: 1px solid #494949;">
                        <?= $hallazgo['contratista'] ? $hallazgo['contratista'] : ''; ?>
                    </td>
                    <td style="border-bottom: 1px solid #494949;">
                        <?= $hallazgo['responsable'] ? $hallazgo['responsable'] : ''; ?>
                    </td>
                </tr>
            </tbody>
            ...
            <thead style="border-top: 1px solid #494949; border-bottom: 1px solid #494949;">
                <tr>
                    <th
                        style="width: 50%; padding: 3px 0; background-color: #f1f1f1;border-right: 1px solid #494949; color: #343434;">
                        Segundo Responsable</th>
            ...
            <tbody>
                <tr>
                    <td>
                        <?= $hallazgo['relevo'] ? $hallazgo['relevo'] : ''; ?>
                    </td>
                    <td>
                        <?= $hallazgo['fecha_cierre_format'] ? $hallazgo['fecha_cierre_format'] : ''; ?>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table width="100%;"
            ...
            <thead>
                <tr>
                    <th colspan="3"
                        style="padding: 3px 0; border-bottom: 1px solid #494949; background-color: #f1f1f1; border-radius: 5px 5px 0 0; color: #343434;">
                        Adjuntos</th>
                </tr>
            </thead>
                    ...
                    <?php foreach ($hallazgo['adjuntos'] as $adj): ?>
                        <tr>
                            <td style="padding: 10px; text-align: left; width: 25%;">
                                <img style="width: 150px; height: 100px; border-radius: 10px;"
    ...
    <?php else: ?>
        <table width="100%;" style="border: 1px solid #494949; border-radius: 5px; margin-top: 15px;">
            ...
            <tbody style="padding: 10px;">
                <tr>
                    <td style="font-size: 12px; color: #686868; text-align: center;"><em>No se ha realizado una
                            observación</em></td>
                </tr>
            </tbody>
        </table>
