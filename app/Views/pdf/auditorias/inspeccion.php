...
<body>
    <div class="footer">
        Oldelval | <?= $auditoria['inspeccion'] ?> N°<?= $auditoria['id_auditoria']; ?> <span class="pagenum"></span>
    </div>
    <!-- Encabezado -->
    <table width='100%' style="border: 1px solid #494949; border-radius: 5px;">
        ...
        <th style="width: 80%; text-align: center; color: #494949; padding-top: 5px; letter-spacing: 1px;">
            <?= $auditoria['inspeccion'] ?> - N°<?= $auditoria['id_auditoria']; ?>
        </th>
    </table>
    ...
    <table width='100%' style="border: 1px solid #494949; border-radius: 5px; margin-top: 3px;">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 20%;color: #686868; text-align: center; font-size: 13px;">
                    <?= $auditoria['fecha_carga_format'] ? $auditoria['fecha_carga_format'] : ''; ?>
                </td>
                <td style="width: 40%;color: #686868; text-align: center; font-size: 13px;border-left: 1px solid #494949;">
    ...
    <table width="100%;" style="border: 1px solid #494949; border-radius: 5px; margin-top: 6px; font-size: 12px; text-align: center; color: #686868;">
        <thead>
            <tr>
                ...
                <?php if ($auditoria['cant_personal'] != '') : ?>
        ...
        <tbody style="border-bottom: 1px solid #494949;">
            <tr>
                <td class="td_content"><?= isset($auditoria['contratista']) ? $auditoria['contratista'] : ''; ?></td>
                <td class="td_content"><?= isset($auditoria['supervisor_responsable']) ? $auditoria['supervisor_responsable'] : ''; ?></td>
                <?php if ($auditoria['cant_personal'] != '') : ?>
                    <td class="td_content"><?= isset($auditoria['cant_personal']) ? $auditoria['cant_personal'] : ''; ?></td>
                <?php else : ?>
                    <td class="td_content"><?= isset($auditoria['cant_personal']) ? $auditoria['cant_personal'] : ''; ?></td>
                <?php endif; ?>

                <td class="td_content"><?= isset($auditoria['num_informe']) ? $auditoria['num_informe'] : '---'; ?></td>
            </tr>
        </tbody>
        ...
        <tbody>
            <tr>
                <td class="td_content_dos"><?= isset($auditoria['proyecto']) ? $auditoria['proyecto'] : ''; ?></td>
                <td class="td_content_dos"><?= isset($auditoria['modulo']) ? $auditoria['modulo'] : 'No Aplica'; ?></td>
                <td class="td_content_dos"><?= isset($auditoria['estacion']) ? $auditoria['estacion'] : 'No Aplica'; ?></td>
                <td class="td_content_dos"><?= isset($auditoria['sistema']) ? $auditoria['sistema'] : 'No Aplica'; ?></td>
            </tr>
        </tbody>
    ...
    <?php if (count($auditoria['hallazgos']) > 0) : ?>
        ...
        foreach ($auditoria['hallazgos'] as $hallazgo) : ?>
            <table width="100%;" style="border: 1px solid #494949; border-radius: 5px; margin-top: 15px;">
                <th style="font-size: 12px; color: #64748B; padding: 4px 0; background-color: #f5f5f5; border-radius: 5px;">Observación #<?= $aux ?></th>
            </table>
            ...
            <table width="100%;" style="border: 1px solid #494949; border-radius: 5px; margin-top: 15px; font-size: 12px; text-align: center; color: #686868; ">
                ...
                <tbody>
                    <tr>
                        <td style="width: 20%; border-right: 1px solid #494949; padding: 3px 0; <?= $hallazgo['significancia'] == 1 ? 'background-color: #f1f1f1; color: #343434; border-top: 1px solid #494949;' : '' ?>">
                            Aceptable</td>
                        <td style="width: 20%; border-right: 1px solid #494949; padding: 3px 0; <?= $hallazgo['significancia'] == 2 ? 'background-color: #ACFF8A; color: #343434; border-top: 1px solid #494949;' : '' ?>">
                            Moderado</td>
                        <td style="width: 20%; border-right: 1px solid #494949; padding: 3px 0; <?= $hallazgo['significancia'] == 3 ? 'background-color: #FFD68A; color: #343434; border-top: 1px solid #494949;' : '' ?>">
                            Significativo</td>
            ...
            <table width="100%;" style="border: 1px solid #494949!important; border-radius: 5px; margin-top: 15px; font-size: 12px; text-align: center; color: #686868; ">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="border-bottom: 1px solid #494949;"><?= $hallazgo['usuario_responsable'] ? $hallazgo['usuario_responsable'] : ''; ?></td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <td><?= $hallazgo['relevo_responsable'] ? $hallazgo['relevo_responsable'] : ''; ?></td>
                        <td><?= $hallazgo['fecha_cierre_f'] ? $hallazgo['fecha_cierre_f'] : ''; ?></td>
                    </tr>
                </tbody>
            </table>
