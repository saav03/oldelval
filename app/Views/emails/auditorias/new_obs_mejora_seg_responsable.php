                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Estimado <?= isset($responsable) ? $responsable : '' ?>, se ha creado una nueva observación en la Inspección</p>
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Usted ha sido seleccionado como relevo para responder en esta observación (En caso de ser necesario)</p>
