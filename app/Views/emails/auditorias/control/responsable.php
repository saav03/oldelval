                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <h1 style="font-size:24px;margin:5px 0; text-align: center; letter-spacing: 1.2px;">Auditoría - CheckList Control</h1>
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Estimado <?= $responsable; ?>, usted tiene responsabilidad/es asignada/s en esta observación</p>
