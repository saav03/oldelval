                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Estimado <b><?= $usuario_carga_descargo ?></b>, <?= $estado == 1 ? 'aceptaron' : 'rechazaron' ?> el descargo previamente cargado</p>
                                        <p style="margin:20px 0 12px 0;font-size:15px;line-height:24px;"><b>Respondió: </b><?= $usuario_carga_hallazgo ?></p>
