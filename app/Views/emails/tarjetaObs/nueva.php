                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Estimado <?= $datos[0]['nombre_u_carga'] . ' ' . $datos[0]['apellido_u_carga'] ?>, ha creado una nueva tarjeta de observaciones</p>

                                        <?php if (isset($datos['responsable'])) { ?>
                                            <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Se solicita a <?= $datos['responsable']['nombre_u_responsable'] . ' ' . $datos['responsable']['apellido_u_responsable']  ?>.</p>
                                        <?php } else { ?>
