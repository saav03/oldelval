                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Estimado <?= $datos['responsable']['nombre_u_responsable'] . ' ' . $datos['responsable']['apellido_u_responsable'] ?>, <br> 
                                        Se le notifica que se realizó una Tarjeta M.A.S donde se implementó un plan de acción a su nombre.</p>
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px; text-align: center;">No se requiere tratamiento</p>
