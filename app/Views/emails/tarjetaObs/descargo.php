                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;">Estimado <?= $datos['u_nombre_carga'] . ' ' . $datos['u_apellido_carga'] ?>, se ha generado un descargo hacia la observación N°<?= $datos['id_obs']; ?></p>
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px; text-align: center;"><b>Descripción del Descargo</b></p>
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px; text-align: center; padding: 7px; border-radius: 5px; border: 1px solid #f1f1f1;"><?= $datos['motivo'] ?></p>
                                        <p style="margin:20px 0 12px 0;font-size:15px;line-height:24px;"><b>Respondió: </b><?= $datos['u_nombre_responde'] . ' ' . $datos['u_apellido_responde'] ?></p>
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;"><b>Fecha Descargo: </b><?= $datos['fecha_motivo'] ?></p>
                                        <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;"><b>Fecha Vencimiento: </b><?= $datos['fecha_vencimiento'] ?></p>
