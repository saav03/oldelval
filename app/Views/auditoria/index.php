    ...
    <div class="row">
        <div class="col-md-12">
            <div class="blister-title-container">
                <h4 class="blister-title">Auditorias</h4>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs" role="tablist">
                                <button type="button" id="tabButtons-1" class="nav-item nav-link btn_aud btn-aud_active active w-50" data-bs-toggle="tab" data-bs-target="#tabButtons-pane-1" role="tab" aria-controls="tabButtons-pane-1" aria-selected="true">Auditorías Control</button>
                                <button type="button" id="tabButtons-2" class="nav-item nav-link btn_aud btn-aud_active w-50" data-bs-toggle="tab" data-bs-target="#tabButtons-pane-2" role="tab" aria-controls="tabButtons-pane-2" aria-selected="false">Auditorías Checklist Vehicular</button>
                            </div>
                        </nav>
                        ...
                        <div class="tab-content">
                            <div id="tabButtons-pane-1" class="tab-pane active" role="tabpanel" aria-labelledby="tabButtons-1">
                                <div class="mt-3" id="tabla_auditoria_control">
                                    <div class="row mb-3"> <!-- Parámetros de Búsquede para las Auditorías de Control -->
                                        <div class="col-xs-12">
                                            <div class="text-center mt-2 mb-2" style="background-color: #e2e8f0; border-radius: 5px;">
                                                <label for="toggle_aud_control" class="d-flex justify-content-center align-items-center" style="cursor: pointer;">
                                                    <h6 style="color: #475569; font-weight: bold; font-size: 13.5px; letter-spacing: 1px; padding: 10px 5px 10px 0; margin: 0;">Búsqueda Avanzada</h6>
                                                ...
                                                <div class="content" style="background-color: white; border: 1px solid #e2e8f0;">
                                                    <div class="p-2">
                                                        ...
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-xs-12 col-md-3 text-start">
                                                                <label class="sz_inp fw-semibold mb-1">Usuario Carga</label>
                                                            ...
                                                            <div class="col-xs-12 col-md-2 text-start">
                                                                <label class="sz_inp fw-semibold mb-1">Fecha Desde <small>(Fecha Carga)</small></label>
                                                                <input type="date" id="fecha_desde_control" name="fecha_desde_control" class="sz_inp form-control">
                                                            </div>
                                                            <div class="col-xs-12 col-md-2 text-start">
                                                                <label class="sz_inp fw-semibold mb-1">Fecha Hasta <small>(Fecha Carga)</small></label>
                            ...
                            <div id="tabButtons-pane-2" class="tab-pane" role="tabpanel" aria-labelledby="tabButtons-2">
                                <div class="mt-3" id="tabla_auditoria_vehicular">
                                    <div class="row mb-3"> <!-- Parámetros de Búsquede para las Auditorías CheckList Vehicular -->
                                        <div class="col-xs-12">
                                            <div class="text-center mt-2 mb-2" style="background-color: #e2e8f0; border-radius: 5px;">
