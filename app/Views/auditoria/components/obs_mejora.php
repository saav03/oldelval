            ...
            <div class="col-xs-12">
                <fieldset style="border-right: none;">
                    ...
                    <div class="p-3 pt-1 text-center">
                        <div class="btn-group btn-group-toggle" style="width: 50%;" role="group" aria-label="">
        ...
        <?php else : ?>
            ...
            <div class="col-xs-12">
                <fieldset style="border-right: none;">
                    ...
                    <div class="p-3 pt-1 text-center">
                        <div class="btn-group btn-group-toggle" style="width: 50%;" role="group">
            ...
            <?php if (!empty($h['adjuntos'])) { ?>
                <?php foreach ($h['adjuntos'] as $adj) : ?>
                    <div class="col-xs-12 col-md-4 text-center">
                        ...
                        <?php else : ?>
                            <a href="<?= base_url("uploads/auditorias/hallazgos") . '/' . $adj['adjunto'] ?>" target="_blank">
                                <img id="img_descargo" src="<?= base_url("uploads/auditorias/hallazgos") . '/' . $adj['adjunto'] ?>" alt="Adjunto del Hallazgo">
                            </a>
                        <?php endif; ?>
            ...
            <?php if (count($h['descargos']) > 0) : ?>
                ...
                foreach ($h['descargos'] as $d) : ?>
                                    ...
                                    <?php if (count($d['descargos_adj']) > 0) { ?>
                                        <?php foreach ($d['descargos_adj'] as $d_adj) : ?>
                                            ...
                                            <div class="col-xs-12 col-md-4 text-center">
                                                ...
                                                <?php if (strpos($d_adj['adjunto'], '.pdf')) : ?>
                                                    <a href="<?= base_url("uploads/auditorias/descargos") . '/' . $d_adj['adjunto'] ?>" target="_blank">
                                                        <img id="img_descargo" src="<?= base_url("assets/img/pdf_adj_show.png") ?>" alt="Adjunto del PDF">
                                                    </a>
                                                <?php else : ?>
                                                    <a href="<?= base_url("uploads/auditorias/descargos") . '/' . $d_adj['adjunto'] ?>" target="_blank">
                                                        <img id="img_descargo" src="<?= base_url("uploads/auditorias/descargos") . '/' . $d_adj['adjunto'] ?>" alt="Adjunto del Hallazgo">
                                                    </a>
                                                <?php endif; ?>
                    ...
                    <?php if ($d['respuesta'] != null && $d['estado'] == 1) { ?>
                        <div class="card mt-3 p-0" style="width: 80%; margin: 0 8px 14px auto; box-shadow: 4px 4px 5px 0px rgba(189,186,186,0.75); border-top: 1px solid #beebc2!important; border-right: 1px solid rgba(189,186,186,0.75)!important; border-bottom: 1px solid rgba(189,186,186,0.75)!important; border-left: 1px solid #beebc2!important;">
