                    ...
                    <fieldset style="border-right: none;">
                        ...
                        <div class="p-3 pt-1 text-center">
                            <div class="btn-group btn-group-toggle" style="width: 80%;" role="group" aria-label="">
                                <input id="aceptable" type="checkbox"
                                    class="btn-check blanco_check" value="1" autocomplete="off" disabled <?= $h['significancia'] == 1 ? 'checked' : '' ?>>
                                <label class="btn blanco btnsToggle riesgos" for="aceptable">Aceptable</label>

                                <input id="moderado" type="checkbox"
                                    class="btn-check verde_check" value="2" autocomplete="off" disabled <?= $h['significancia'] == 2 ? 'checked' : '' ?>>
                                <label class="btn verde btnsToggle riesgos" for="moderado">Moderado</label>

                                <input id="significativo" type="checkbox"
                                    class="btn-check amarillo_checked" value="3" autocomplete="off" disabled <?= $h['significancia'] == 3 ? 'checked' : '' ?>>
                                <label class="btn amarillo btnsToggle riesgos" for="significativo">Significativo</label>

                                <input id="intolerable" type="checkbox"
                                    class="btn-check rojo_check" value="4" autocomplete="off" disabled <?= $h['significancia'] == 4 ? 'checked' : '' ?>>
