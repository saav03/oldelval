    ...
    <div class="card" style="padding: 10px 35px 35px 35px;">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <fieldset style="border-right: none;">
                        ...
                        <div class="p-3 pt-1">
                            <textarea style="border: none;" name="hallazgo" cols="30" rows="5" class="form-control sz_inp" readonly><?= $h['hallazgo'] ? $h['hallazgo'] : ''; ?></textarea>
                        </div>
                    </fieldset>
                </div>
                <div class="col-xs-12 col-md-6">
                    <fieldset style="border-right: none;">
                        ...
                        <div class="p-3 pt-1">
                            <textarea style="border: none;" cols="30" rows="5" class="form-control sz_inp" readonly><?= $h['plan_accion'] ? $h['plan_accion'] : ''; ?></textarea>
                        </div>
                    </fieldset>
                </div>
                ...
                <div class="col-xs-12 col-md-6">
                    <fieldset style="border-right: none;">
                        ...
                        <div class="p-3 pt-1">
                            <input type="text" class="form-control sz_inp" value="<?= $h['responsable'] ? $h['responsable'] : ''; ?>" readonly>
                        </div>
                    </fieldset>
                </div>
                <div class="col-xs-12 col-md-6">
                    <fieldset style="border-right: none;">
                        ...
                        <div class="p-3 pt-1">
                            <input type="text" class="form-control sz_inp" value="<?= $h['relevo'] ? $h['relevo'] : 'No Aplica'; ?>" readonly>
                        </div>
                    </fieldset>
                </div>
                <div class="col-xs-12 col-md-6">
                    <fieldset style="border-right: none;">
                        ...
                        <div class="p-3 pt-1">
                            <input type="text" class="form-control sz_inp text-center" value="<?= $h['fecha_cierre_format'] ? $h['fecha_cierre_format'] : ''; ?>" readonly>
                        </div>
                    </fieldset>
                </div>
            </div>
                    ...
                    <?php foreach ($h['adjuntos'] as $adj) : ?>
                        <div class="col-xs-12 col-md-4 text-center">
                            <a href="<?= base_url("uploads/auditorias/hallazgos") . '/' . $adj['adjunto'] ?>" target="_blank">
                                <img id="img_descargo" src="<?= base_url("uploads/auditorias/hallazgos") . '/' . $adj['adjunto'] ?>" alt="">
                            </a>
        ...
        <div>
            ...
            <div class="row">
                ...
                ?>
                <?= view('auditoria/tarea_de_campo/aud_descargos', $descargos) ?>
        ...
        <?php if (!is_null($h['cierre'])) { ?>
            ...
            <div class="card">
                <div class="card-header" style="font-weight: 600; letter-spacing: 1.5px; text-align: center; background-color: #d7d7d7;">
                    Tarjeta de Observación Cerrada (<?= $h['tiempo']['rta_cierre_obs'] ? 'A tiempo' : 'Fuera de Tiempo' ?>)
                </div>
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <span class="text-center">Cerrada el día <?= $h['cierre']['fecha_hora_cierre'] ?> por <?= $h['cierre']['usuario_cierre'] ?> (<?= $h['tiempo']['diff']->days ?> <?= $h['tiempo']['rta_cierre_obs'] ? 'días antes' : 'días atrasados' ?>)</span>
                    </div>
            ...
            <?php if ($h['id_usuario_carga'] == session()->get('id_usuario')) : ?>
                <div>
                    ...
                    <?php if (empty($h['descargos'])) : ?>
                        <br>
                        <span class="fw-semibold"><small><em>(Deben haber descargos para poder cerrar ésta observación)</em></small></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        <?php } ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            ...
                            <input type="hidden" name="tipo_obs" value="3">
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            ...
                            <input type="hidden" name="id_hallazgo" value="<?= isset($h['id_hallazgo']) ? $h['id_hallazgo'] : '' ?>">
                        </div>
