...
class Model_movimiento extends Model
{
    ...
    public function getRecentActivity() {
        ...
        $builder->select("mm.id id_mov, mm.id_usuario, mm.id_afectado, CONCAT(u.nombre, ' ', u.apellido) nombre_usuario, mm_mod.id id_modulo, mm_mod.nombre modulo, mm_accion.id id_accion, mm_accion.nombre, mm.fecha_hora")
