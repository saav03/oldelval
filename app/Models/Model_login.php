...
class Model_login extends Model {
    ...
    public function checklogin($usuario, $password){ 
        ...
        $builder->select('u.id, u.nombre nombre,CONCAT(u.nombre," ",u.apellido) nombrecompleto, u.usuario, u.clave, u.id_grupo, u.competencia, u.imagen_perfil img_perfil,u.superadmin');
